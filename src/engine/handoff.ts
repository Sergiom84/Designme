...
export function buildHandoffPrompt(
  ...
  return [
    ...
    `Ajustes: densidad=${tweaks.density}, tono=${tweaks.tone}, movimiento=${tweaks.motion}, radio=${tweaks.radius}px, marco móvil=${tweaks.showDevice ? 'sí' : 'no'}`,
    '',
    'Entrega un prototipo HTML/CSS/JS autónomo, adaptable, con estados interactivos reales, texto listo para revisar y un pequeño panel de ajustes persistente en localStorage.',
